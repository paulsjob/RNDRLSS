...
export const DeleteAssetModal: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      >
        <div className="w-16 h-16 bg-red-950/20 rounded-full flex items-center justify-center mx-auto mb-6 border border-red-500/10">
        ...
        <p className="text-sm text-zinc-500 mb-8 leading-relaxed px-4">
          Are you sure you want to remove <span className="text-zinc-300 font-bold">"{asset.name}"</span>? This action cannot be undone.
        </p>
